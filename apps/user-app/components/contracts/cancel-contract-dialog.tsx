    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-2xl shadow-xl max-w-lg w-full mx-4 overflow-hidden">
                ...
                {/* Footer */}
                <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-neutral-200 bg-neutral-50/50">
                    <button
                        onClick={handleClose}
                        disabled={isSubmitting}
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 bg-red-600 hover:bg-red-700 disabled:bg-neutral-300 text-white font-medium py-2 px-4 rounded-lg text-sm transition-colors"
                    >
                        {isSubmitting ? (
                            <>
