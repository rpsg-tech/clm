    ...
    return (
        <div className="space-y-6 animate-in fade-in zoom-in-95 duration-300">
            <div className="text-center space-y-2">
                <h2 className="text-2xl font-bold text-gray-900">Select a Contract Template</h2>
                <p className="text-gray-500">Choose the legal framework for your new contract.</p>
            </div>
            ...
            {templates.length === 0 ? (
                <div className="text-center py-12 bg-gray-50 rounded-3xl border border-dashed border-gray-200">
                    ...
                    <p className="text-gray-500 mt-1">Please contact your admin to create templates.</p>
                </div>
            ) : (
                        ...
                        return (
                            <button
                                ...
                                className={`relative p-6 rounded-3xl border-2 text-left transition-all duration-300 group hover:shadow-xl hover:-translate-y-1 ${isSelected
                                    ...
                                    : "border-gray-100 bg-white hover:border-orange-200 hover:bg-orange-50/10"
                                    }`}
                            >
                                {isSelected && (
                                ...
                                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-5 transition-all duration-300 ${isSelected
                                    ...
                                    : "bg-gray-100 text-gray-500 group-hover:bg-orange-100 group-hover:text-orange-600 group-hover:scale-110"
                                    }`}>
                                    <FileText size={26} />
                                </div>

                                <h3 className={`font-bold text-lg mb-2 transition-colors ${isSelected ? "text-orange-900" : "text-gray-900 group-hover:text-gray-900"}`}>
                                    {template.name}
                                </h3>

                                <p className="text-sm text-gray-500 leading-relaxed group-hover:text-gray-600 line-clamp-2">
