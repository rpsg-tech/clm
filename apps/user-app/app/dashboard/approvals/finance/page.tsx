...
import { CheckCircle, XCircle, Clock, FileText, ChevronRight, User, AlertCircle, ArrowRight, DollarSign } from 'lucide-react';
...
export default function FinanceApprovalsPage() {
    ...
    const canAct = hasPermission('approval:finance:act');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-[calc(100vh-80px)] p-6 overflow-hidden">
            ...
            <div className="lg:col-span-4 flex flex-col h-full overflow-hidden">
                <div className="mb-4 pr-2 flex items-center justify-between">
                    <div>
                        <h1 className="text-xl font-bold text-slate-900 tracking-tight">Finance Review</h1>
                    ...
                    <>
                        ...
                        <div className="px-6 py-5 border-b border-slate-100 flex items-start justify-between bg-slate-50/50">
                            <div className="space-y-1">
                                <div className="flex items-center gap-2 mb-1.5">
                                    <Badge className="bg-emerald-50 text-emerald-700 border border-emerald-100 font-bold text-[9px] px-1.5 py-0.5 rounded uppercase tracking-wide">
                                        Audit Required
                                    </Badge>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
                            <div className="max-w-3xl mx-auto space-y-6">
                                <div className="bg-emerald-50 rounded-xl border border-emerald-100 p-4 flex gap-3">
                                    <div className="mt-0.5">
                                        <DollarSign className="w-4 h-4 text-emerald-600" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-emerald-900 text-xs uppercase tracking-wide mb-1">Financial Audit</h4>
                                        <p className="text-emerald-800/90 text-sm font-medium leading-relaxed">
                                            Please verify the payment terms, total contract value, and billing schedule. Ensure the budget code corresponds with the department's fiscal allocation.
                                        </p>
                                    </div>
                                </div>
