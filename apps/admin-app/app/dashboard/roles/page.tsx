                                    ...
                                    <td colSpan={4} className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center max-w-xs mx-auto space-y-4">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-slate-400 font-medium text-xs">There are no security roles defined in the system yet.</p>
                                            </div>
                                            <Link href="/dashboard/roles/new">
                                                <Button className="bg-orange-600 hover:bg-orange-700 text-white rounded-xl px-6 h-10 font-bold uppercase text-xs tracking-wide shadow-lg shadow-orange-600/20 transition-all">
                                                    Create First Role
                                                </Button>
                                            </Link>
                                        </div>
